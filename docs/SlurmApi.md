...
with slurmrestpy.ApiClient(configuration) as api_client:
    ...
    api_instance = slurmrestpy.SlurmApi(api_client)
    job_id = 'job_id_example' # str | Job ID
    v0041_job_desc_msg = slurmrestpy.V0041JobDescMsg() # V0041JobDescMsg | Job update description (optional)
...
with slurmrestpy.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurmrestpy.SlurmApi(api_client)
    v0041_job_alloc_req = slurmrestpy.V0041JobAllocReq() # V0041JobAllocReq | Job allocation description (optional)
...
with slurmrestpy.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurmrestpy.SlurmApi(api_client)
    v0041_job_submit_req = slurmrestpy.V0041JobSubmitReq() # V0041JobSubmitReq | Job description (optional)
...
with slurmrestpy.ApiClient(configuration) as api_client:
    ...
    api_instance = slurmrestpy.SlurmApi(api_client)
    node_name = 'node_name_example' # str | Node name
    v0041_update_node_msg = slurmrestpy.V0041UpdateNodeMsg() # V0041UpdateNodeMsg | Node update description (optional)
...
with slurmrestpy.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurmrestpy.SlurmApi(api_client)
    v0041_update_node_msg = slurmrestpy.V0041UpdateNodeMsg() # V0041UpdateNodeMsg | Nodelist update description (optional)
...
with slurmrestpy.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurmrestpy.SlurmApi(api_client)
    v0042_kill_jobs_msg = slurmrestpy.V0042KillJobsMsg() # V0042KillJobsMsg | Signal or cancel jobs (optional)
...
with slurmrestpy.ApiClient(configuration) as api_client:
    ...
    api_instance = slurmrestpy.SlurmApi(api_client)
    job_id = 'job_id_example' # str | Job ID
    v0042_job_desc_msg = slurmrestpy.V0042JobDescMsg() # V0042JobDescMsg | Job update description (optional)
...
with slurmrestpy.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurmrestpy.SlurmApi(api_client)
    v0042_job_alloc_req = slurmrestpy.V0042JobAllocReq() # V0042JobAllocReq | Job allocation description (optional)
...
with slurmrestpy.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurmrestpy.SlurmApi(api_client)
    v0042_job_submit_req = slurmrestpy.V0042JobSubmitReq() # V0042JobSubmitReq | Job description (optional)
...
with slurmrestpy.ApiClient(configuration) as api_client:
    ...
    api_instance = slurmrestpy.SlurmApi(api_client)
    node_name = 'node_name_example' # str | Node name
    v0042_update_node_msg = slurmrestpy.V0042UpdateNodeMsg() # V0042UpdateNodeMsg | Node update description (optional)
...
with slurmrestpy.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurmrestpy.SlurmApi(api_client)
    v0042_update_node_msg = slurmrestpy.V0042UpdateNodeMsg() # V0042UpdateNodeMsg | Nodelist update description (optional)
